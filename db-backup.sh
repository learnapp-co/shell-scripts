...
# After sourcing credentials: S3 / AWS may be set in $CREDENTIAL_FILE or inherited from the
# environment (cron, shell). sudo strips env by default — use sudo -E or
# sudo --preserve-env=S3_BACKUP_URI,AWS_REGION when exporting these in your shell.
